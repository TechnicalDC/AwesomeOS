...
local favourites = require("modules.ui.tasklist.favourites")
local icons = require("modules.ui.tasklist.icons")
local get_app_widget = require("modules.ui.tasklist.app-widget")
...
for i, v in pairs(favourites) do
    ...
    widget:get_children_by_id("custom_icon")[1].markup = "<span foreground='"..icons[v["name"]]["color"] .. "'>" .. icons[v["name"]]["icon"] .. "</span>"

    widget:get_children_by_id("selected_indicator")[1].bg = theme.bg_normal
